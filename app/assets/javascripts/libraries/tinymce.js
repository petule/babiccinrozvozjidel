...
function tinymce_ready()
{
	...
	tinymce.init({
		 ...
		 */
		plugins: "fullscreen paste charmap codemirror hr image link nonbreaking searchreplace table visualblocks visualchars textcolor colorpicker",
		
		/**
		 * Toolbar
		 */
		toolbar: "undo redo | styleselect | link image | bold italic forecolor backcolor | alignleft aligncenter alignright alignjustify | bullist numlist indent outdent | fullscreen code",
	...
	tinymce.init({
		 ...
		 * Basic setting
		 */
		selector: "textarea.tinymce-string", /* TinyMCE is applied to all elements with this class */
		theme: "modern", /* Theme of the editor */
		height : 1,
		max_height: 1,
		language : "cs", /* Editor language */
		fix_list_elements : true, /* Fix nested ul/ol elements */
		paste_as_text: true, /* Paste as text set as default */
		paste_word_valid_elements: "b,strong,i,em", /* Paste form word cleanup */
		content_css: "/assets/libraries/tinymce_string.css", /* Custom CSS file for content */
		entity_encoding : "raw", /* All characters will be stored in non-entity form except &amp; &lt; &gt; &quot; */
		relative_urls: false, /* Don't convert URLs to relative paths */
		forced_root_block : "",
